 ...
 */
public class ChapterDetailActivity extends Activity implements ChapterDetailFragment.Callbacks {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      if (!TextUtils.isEmpty(chapterSectionQueryString) && !App.processedDeepLinks) {
        arguments.putString(ChapterDetailFragment.ARG_CHAPTER_SECTION_QUERY_STRING, chapterSectionQueryString);
        Log.d(">>> ChapterDetailActivity: processedDeepLinks:", Boolean.toString(App.processedDeepLinks));
      }
      ChapterDetailFragment fragment = new ChapterDetailFragment();
      fragment.setArguments(arguments);
      getFragmentManager().beginTransaction().add(R.id.chapter_detail_container, fragment).commit();
    }
  }
