...
public class ChapterListFragment extends ListFragment implements DeepLinkHelperCallback {
  ...
  public void setActivateOnItemClick(boolean activateOnItemClick) {
    ...
    chapterList.setChoiceMode(activateOnItemClick ? ListView.CHOICE_MODE_SINGLE : ListView.CHOICE_MODE_NONE);
  ...
  public void ProcessDeepLink(String chapterName, String chapterSectionQueryString) {
    ...
    Log.d(">>> ChapterListFragment: processedDeepLinks:", Boolean.toString(App.processedDeepLinks));
  }
